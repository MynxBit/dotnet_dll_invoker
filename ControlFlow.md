...
**Trigger:** Right-click DLL → **Check Dependencies**.
**Flow:**
1.  Enumerate `GetReferencedAssemblies()`.
2.  Attempt resolution (Same directory / Standard probing).
3.  Classify: **Resolved (GREEN)** or **Unresolved (RED)**.
**Outcome:** Informational only. No auto-download. Invocation allowed but risky.
